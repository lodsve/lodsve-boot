...
package com.lodsve.boot.mongodb.client;
...
import com.mongodb.internal.binding.*;
...
public class MongoClientDelegate {
    ...
    public MongoClientDelegate(final Cluster cluster, final CodecRegistry codecRegistry, final Object originator) {
        this(cluster, codecRegistry, originator, null);
    }
