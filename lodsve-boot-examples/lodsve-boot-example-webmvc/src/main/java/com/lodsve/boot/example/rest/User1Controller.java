...
import com.lodsve.boot.example.service.AuthzImpl;
...
public class User1Controller {
    ...
    @Authn
    public User loadUser(@ApiParam(name = "id", value = "用户ID") @PathVariable("id") Long id, @CurrentAccount Account account) {
